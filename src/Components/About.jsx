    ...
    <>
      <div className="relative h-full">
        <div className={`${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          >
            I have Completed My <span className="font-bold">B.Tech Degree </span>From <span className="font-bold">National Institute Of Technology , Manipur .</span><br />
          ...
          >
            ...
            creative way.<br />
            I creates <span className="font-bold">web design</span> for different screen sizes.<br/>
            <br/>
